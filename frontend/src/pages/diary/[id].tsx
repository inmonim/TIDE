...
// export default function DiaryDetail:NextPage<DiaryProps> = ({ diary }) =>{
...
//   const res = await fetch(`https://${process.env.NEXT_PUBLIC_API_URL}/api/diary/detail/public`)
//   const diarys = await res.json()
  
//   const paths = diarys.map((diary: { id: number; }) => ({
//     params: { id: diary.id },
//   }))
...
//   const res = await fetch(`https://${process.env.NEXT_PUBLIC_API_URL}/api/diary/detail/${context.params?.id}`)

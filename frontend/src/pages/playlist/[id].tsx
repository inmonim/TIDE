      ...
      p-[4rem] pt-[2rem] lg12:pr-[calc(200px)] lg12:pl-[calc(15%+100px)] pb-[240px] text-[#eeeeee] flex flex-col min-h-[100vh] pt-[calc(2rem+40px)] bg-gradient-to-t from-blue-900 to-slate-900 `}>
        <div className={`text-[0.85rem] w-[100%] z-[2] select-none h-[100%]`}>
          <div className={`md:flex justify-between items-center`}>
            ...
            {/* 재생관련영역 */}
            <div className={'flex'}>
              <Image src={runButton} alt={'재생'} className={`border p-1 w-8 h-8`}/>
              <Image src={runButton} alt={'셔플'} className={`border p-1 w-8 h-8`}/>
            </div>
            ...
            <p className={`w-full border p-2 rounded-lg text-center ${isPublic==='0'? `bg-blue-700`:`bg-red-700`} mb-2`}> {isPublic==='0'? `공개`:`비공개`} </p>

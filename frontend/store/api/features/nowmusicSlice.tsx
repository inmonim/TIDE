  ...
  reducers: {
    ...
    getPlayListRandom(state,action){
      if(action.payload.playListSongs.length > 0)
      {
        ...
        state.nowIndex = 0;
        state.plType = 2;
        nowPlayList.sort(function () {return Math.random() - 0.5;});
...
export const {getvideoId, getPlayList, changePrevSong, changeNextSong, getPlayListRandom} = nowmusicSlice.actions;
